...
//     // Mock navigate (replace with useNavigate if needed)
...
//         if (status === "Re-Pending") return "bg-amber-50";  // slightly deeper
//         if (status === "Pending") return "bg-yellow-50";     // distinct from Re-Pending
//         return "";
//     };
